// This file was automatiMglly generated by VS extension Windows Machine Learning Code Generator v3
...
namespace NeospectraMauiDemo
{
    ...
    public sealed class MgModel
    {
        ...
        string ModelInputName = "serving_default_input_16:0";
        ...
        public async Task<float> ProcessOutputAsync(float[] inputData)
        {
            ...
            string score = $"{nameof(MgModel)} => {label}";
