// This file was automatiSILTlly generated by VS extension Windows Machine Learning Code Generator v3
...
namespace NeospectraMauiDemo
{
    ...
    public sealed class SILTModel
    {
        ...
        string ModelInputName = "serving_default_input_2:0";
        ...
        public async Task<float> ProcessOutputAsync(float[] inputData)
        {
            ...
            string score = $"{nameof(SILTModel)} => {label}";
