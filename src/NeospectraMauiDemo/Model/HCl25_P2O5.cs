// This file was automatiHCl25_P2O5lly generated by VS extension Windows Machine Learning Code Generator v3
...
namespace NeospectraMauiDemo
{
    ...
    public sealed class HCl25_P2O5Model
    {
        ...
        string ModelInputName = "serving_default_input_9:0";
        ...
        public async Task<float> ProcessOutputAsync(float[] inputData)
        {
            ...
            string score = $"{nameof(HCl25_P2O5Model)} => {label}";
