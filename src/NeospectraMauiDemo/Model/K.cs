// This file was automatiKlly generated by VS extension Windows Machine Learning Code Generator v3
...
namespace NeospectraMauiDemo
{
    ...
    public sealed class KModel
    {
        ...
        string ModelInputName = "serving_default_input_17:0";
        ...
        public async Task<float> ProcessOutputAsync(float[] inputData)
        {
            ...
            string score = $"{nameof(KModel)} => {label}";
