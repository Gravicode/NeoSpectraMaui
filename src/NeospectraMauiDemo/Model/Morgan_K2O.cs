// This file was automatiMorgan_K2Olly generated by VS extension Windows Machine Learning Code Generator v3
...
namespace NeospectraMauiDemo
{
    ...
    public sealed class Morgan_K2OModel
    {
        ...
        string ModelInputName = "serving_default_input_13:0";
        ...
        public async Task<float> ProcessOutputAsync(float[] inputData)
        {
            ...
            string score = $"{nameof(Morgan_K2OModel)} => {label}";
