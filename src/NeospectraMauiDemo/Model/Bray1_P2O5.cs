// This file was automatiBray1_P2O5lly generated by VS extension Windows Machine Learning Code Generator v3
...
namespace NeospectraMauiDemo
{
    ...
    public sealed class Bray1_P2O5Model
    {
        ...
        string ModelInputName = "serving_default_input_12:0";
        ...
        public async Task<float> ProcessOutputAsync(float[] inputData)
        {
            ...
            string score = $"{nameof(Bray1_P2O5Model)} => {label}";
