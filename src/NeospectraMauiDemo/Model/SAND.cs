// This file was automatiSANDlly generated by VS extension Windows Machine Learning Code Generator v3
...
namespace NeospectraMauiDemo
{
    ...
    public sealed class SANDModel
    {
        ...
        string ModelInputName = "serving_default_input_1:0";
        ...
        public async Task<float> ProcessOutputAsync(float[] inputData)
        {
            ...
            string score = $"{nameof(SANDModel)} => {label}";
