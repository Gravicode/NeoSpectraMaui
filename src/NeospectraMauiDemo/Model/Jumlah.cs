// This file was automatiJumlahlly generated by VS extension Windows Machine Learning Code Generator v3
...
namespace NeospectraMauiDemo
{
    ...
    public sealed class JumlahModel
    {
        ...
        string ModelInputName = "serving_default_input_19:0";
        ...
        public async Task<float> ProcessOutputAsync(float[] inputData)
        {
            ...
            string score = $"{nameof(JumlahModel)} => {label}";
