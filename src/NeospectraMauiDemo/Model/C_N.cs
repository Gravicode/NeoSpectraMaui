// This file was automatiC_Nlly generated by VS extension Windows Machine Learning Code Generator v3
...
namespace NeospectraMauiDemo
{
    ...
    public sealed class C_NModel
    {
        ...
        string ModelInputName = "serving_default_input_8:0";
        ...
        public async Task<float> ProcessOutputAsync(float[] inputData)
        {
            ...
            string score = $"{nameof(C_NModel)} => {label}";
