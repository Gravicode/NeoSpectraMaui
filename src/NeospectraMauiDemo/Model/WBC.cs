// This file was automatiWBClly generated by VS extension Windows Machine Learning Code Generator v3
...
namespace NeospectraMauiDemo
{
    ...
    public sealed class WBCModel
    {
        ...
        string ModelInputName = "serving_default_input_6:0";
        ...
        public async Task<float> ProcessOutputAsync(float[] inputData)
        {
            ...
            string score = $"{nameof(WBCModel)} => {label}";
