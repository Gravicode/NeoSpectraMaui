// This file was automatiPH_H2Olly generated by VS extension Windows Machine Learning Code Generator v3
...
namespace NeospectraMauiDemo
{
    ...
    public sealed class PH_H2OModel
    {
        ...
        string ModelInputName = "serving_default_input_4:0";
        ...
        public async Task<float> ProcessOutputAsync(float[] inputData)
        {
            ...
            string score = $"{nameof(PH_H2OModel)} => {label}";
