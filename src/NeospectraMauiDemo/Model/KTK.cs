// This file was automatiKTKlly generated by VS extension Windows Machine Learning Code Generator v3
...
namespace NeospectraMauiDemo
{
    ...
    public sealed class KTKModel
    {
        ...
        string ModelInputName = "serving_default_input_20:0";
        ...
        public async Task<float> ProcessOutputAsync(float[] inputData)
        {
            ...
            string score = $"{nameof(KTKModel)} => {label}";
