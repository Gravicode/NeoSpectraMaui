// This file was automatiHCl25_K2Olly generated by VS extension Windows Machine Learning Code Generator v3
...
namespace NeospectraMauiDemo
{
    ...
    public sealed class HCl25_K2OModel
    {
        ...
        string ModelInputName = "serving_default_input_10:0";
        ...
        public async Task<float> ProcessOutputAsync(float[] inputData)
        {
            ...
            string score = $"{nameof(HCl25_K2OModel)} => {label}";
