...
namespace NeospectraMauiDemo.Driver
{
    public class SWS_P3API
    {
        ...
        BluetoothLEService service { set; get; }
        public SWS_P3API(BluetoothLEService service)
        {
            //this.mContext = pContext;
            this.service = service;
            mP3ConnectionServices = new SWS_P3ConnectionServices(this.service);
        ...
        //@Deprecated
        public async Task<bool> connectToDevice(DeviceCandidate candidateDevice)
        {
            this.service.Device = await this.service.Adapter.ConnectToKnownDeviceAsync(candidateDevice.Id);

            if (this.service.Device.State == DeviceState.Connected)
            {
                mP3ConnectionServices.setmRxBleDevice(this.service.Device);
